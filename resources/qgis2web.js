...
map.getView().fit([2088044.086482, 305201.409815, 2630144.320803, 579765.953130], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">carte nord ubangi</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (59 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'il s\'agit d\'une carte web de nord ubangi province de la rdc';
            }
